...
Live three-message hold and interrupted release recovery across a web restart now passed with no duplicate writes; [evidence](evidence/phase-0/2026-09-05-live-batch-recovery.md). [Held-batch disconnect](evidence/phase-0/2026-09-05-held-batch-disconnect.md) also passed live. Concurrent arrivals and hold crashes still need live proof. General interception, scheduled delivery, paging, production accounts and sending remain disabled.

  ...
  return (
    <details className="connection-details" open={phase !== null}>
      ...
      <div className="connection-content">
        ...
        <p>Restores the single fixture and all saved batch messages to Inbox and checks Gmail before requesting revocation. If recovery fails, access stays saved so you can retry.</p>
